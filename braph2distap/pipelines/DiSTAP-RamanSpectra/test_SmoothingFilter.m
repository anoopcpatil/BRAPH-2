...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	sf = SmoothingFilter( ...
		...
		SmoothingFilter.SP_OUT, SmoothingFilter.getNoValue(), ...
		SmoothingFilter.SP_DICT_OUT, SmoothingFilter.getNoValue(), ...
...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	sf_1 = SmoothingFilter( ...
		...
		SmoothingFilter.SP_DICT_OUT, SmoothingFilter.getNoValue(), ...
		SmoothingFilter.RE_OUT, SmoothingFilter.getNoValue(), ...
		SmoothingFilter.REPF, sf_0.getCallback(13) ... ...
		);
	...
	sf_2 = SmoothingFilter( ...
		...
		SmoothingFilter.SP_DICT_OUT, SmoothingFilter.getNoValue(), ...
		SmoothingFilter.RE_OUT, SmoothingFilter.getNoValue(), ...
		SmoothingFilter.REPF, sf_1.getCallback(13) ... ...
		);
	...
	sf_3 = SmoothingFilter( ...
		...
		SmoothingFilter.SP_DICT_OUT, SmoothingFilter.getNoValue(), ...
		SmoothingFilter.RE_OUT, SmoothingFilter.getNoValue(), ...
		SmoothingFilter.REPF, sf_2.getCallback(13) ... ...
		);
