...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	sp_1 = Spectrum( ...
		...
		Spectrum.WAVELENGTH, sp_0.getCallback(10), ..., ...
		Spectrum.WAVELENGTH_LABELS, Spectrum.getNoValue(), ...
		Spectrum.INTENSITIES, sp_0.getCallback(12), ..., ...
		Spectrum.NO_AQUISITIONS, Spectrum.getNoValue(), ...
		Spectrum.INTENSITY, Spectrum.getNoValue(), ...
		Spectrum.INTENSITY_MEAN, Spectrum.getNoValue() ...
		);
	...
	sp_2 = Spectrum( ...
		...
		Spectrum.WAVELENGTH, sp_1.getCallback(10), ..., ...
		Spectrum.WAVELENGTH_LABELS, Spectrum.getNoValue(), ...
		Spectrum.INTENSITIES, sp_1.getCallback(12), ..., ...
		Spectrum.NO_AQUISITIONS, Spectrum.getNoValue(), ...
		Spectrum.INTENSITY, Spectrum.getNoValue(), ...
		Spectrum.INTENSITY_MEAN, Spectrum.getNoValue() ...
		);
	...
	sp_3 = Spectrum( ...
		...
		Spectrum.WAVELENGTH, sp_2.getCallback(10), ..., ...
		Spectrum.WAVELENGTH_LABELS, Spectrum.getNoValue(), ...
		Spectrum.INTENSITIES, sp_2.getCallback(12), ..., ...
		Spectrum.NO_AQUISITIONS, Spectrum.getNoValue(), ...
		Spectrum.INTENSITY, Spectrum.getNoValue(), ...
		Spectrum.INTENSITY_MEAN, Spectrum.getNoValue() ...
		);
