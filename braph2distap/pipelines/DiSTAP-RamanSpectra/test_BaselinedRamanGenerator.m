...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	brgen = BaselinedRamanGenerator( ...
		...
		BaselinedRamanGenerator.SP_OUT, BaselinedRamanGenerator.getNoValue(), ...
		BaselinedRamanGenerator.SP_DICT_OUT, BaselinedRamanGenerator.getNoValue(), ...
...
if rand() >= (1 - .01) * BRAPH2TEST.RANDOM
	...
	brgen_1 = BaselinedRamanGenerator( ...
		...
		BaselinedRamanGenerator.SP_DICT_OUT, BaselinedRamanGenerator.getNoValue(), ...
		BaselinedRamanGenerator.RE_OUT, BaselinedRamanGenerator.getNoValue(), ...
		BaselinedRamanGenerator.REPF, brgen_0.getCallback(13) ... ...
		);
	...
	brgen_2 = BaselinedRamanGenerator( ...
		...
		BaselinedRamanGenerator.SP_DICT_OUT, BaselinedRamanGenerator.getNoValue(), ...
		BaselinedRamanGenerator.RE_OUT, BaselinedRamanGenerator.getNoValue(), ...
		BaselinedRamanGenerator.REPF, brgen_1.getCallback(13) ... ...
		);
	...
	brgen_3 = BaselinedRamanGenerator( ...
		...
		BaselinedRamanGenerator.SP_DICT_OUT, BaselinedRamanGenerator.getNoValue(), ...
		BaselinedRamanGenerator.RE_OUT, BaselinedRamanGenerator.getNoValue(), ...
		BaselinedRamanGenerator.REPF, brgen_2.getCallback(13) ... ...
		);
