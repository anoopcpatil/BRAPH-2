classdef SmoothingFilter < REAnalysisModule
	...
	%  <strong>10</strong> <strong>RE_OUT</strong> 	RE_OUT (query, item) is the output Raman Experiment with smooth spectra as a result.
	...
	%
	%
	% See also REAnalysisModule, CosmicRayNoiseRemover, RamanExperiment, Spectrum.
	...
	methods (Static) % inspection
		...
		function tag = getPropTag(pointer)
			...
			if ischar(pointer)
				...
				%CET: Computational Efficiency Trick
				smoothingfilter_tag_list = { 'ELCLASS'  'NAME'  'DESCRIPTION'  'TEMPLATE'  'ID'  'LABEL'  'NOTES'  'TOSTRING'  'RE_IN'  'RE_OUT'  'REPF' };
		...
		function prop_category = getPropCategory(pointer)
			...
			%CET: Computational Efficiency Trick
			smoothingfilter_category_list = { 1  1  1  3  4  2  2  6  4  6  9 };
		...
		function prop_format = getPropFormat(pointer)
			...
			%CET: Computational Efficiency Trick
			smoothingfilter_format_list = { 2  2  2  8  2  2  2  2  8  8  8 };
		...
		function prop_settings = getPropSettings(pointer)
			...
			switch prop %CET: Computational Efficiency Trick
				...
				case 10 % SmoothingFilter.RE_OUT
